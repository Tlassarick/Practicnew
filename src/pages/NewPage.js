          ...
          <div className="about">
            <div className="text-box-about">
              <span className="span-about">
                ...
                послуг, що пропонуються Головним Управлінням Державної
                податкової служби (ГУДПС) у Київській області. Розроблена нами
                інформаційна система є локальною, доступ до неї мають виключно
                співробітники установи.
              </span>
            </div>
          </div>
          <div className="why">
            <div className="text-box-why">
              <span className="span-why">
                Система спрямована на забезпечення ефективної внутрішньої
                взаємодії та організації роботи податкової служби, підвищуючи
                прозорість та зручність внутрішніх процесів.
              </span>
            </div>
          </div>
          <div className="what">
            <div className="text-box-what">
              <span className="span-what">
                Наша мета – підвищити прозорість та зручність внутрішніх
                процедур, сприяючи більш ефективному виконанню завдань та
                взаємодії між відділами податкової служби
              </span>
            </div>
          </div>
        </div>
        <div class="right-section">
          ...
          <div className="text-bot-wtf">
            <span className="text-wtf">
              ...
              наведено основні можливості та інструкції з використання
          ...
          <div className="telephone-box">
            <div className="text-box-telephone">
              ...
              <li className="list-box">
                Номер телефону: Шукайте за номером телефону для швидкого доступу
                до контакту
              </li>
            </div>
            <button
